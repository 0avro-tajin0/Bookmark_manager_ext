...
(function () {
  ...
  const PRICING = {
    en: {
      year:     { amount: 19,  currency: 'USD', display: '$19' },
      lifetime: { amount: 29,  currency: 'USD', display: '$29' },
    },
    ru: {
  ...
  const STR = {
    en: {
      ...
      'trial.chooseFooter': 'Once you make a selection, BlackCodex Bookmark Manager will open your workspace.',
      // checkout wait
      ...
      'paywall.desc': 'Your bookmarks are safe.<br>Unlock BlackCodex Bookmark Manager to continue using it.',
      ...
      'activation.enterSub': "After your purchase you'll receive a code by email.<br>Paste it here to unlock BlackCodex Bookmark Manager.",
      ...
      'activation.unlocked': 'BlackCodex Bookmark Manager is now unlocked. Enjoy!',
      ...
      'st.thanks': 'Thanks for supporting BlackCodex Bookmark Manager.',
      ...
      'st.contact': 'Contact',
      // limit hints
      'limit.pages': 'Sign in to create multiple pages.',
      'limit.boards': 'Sign in to add more than 3 boards.',
      'limit.bookmarks': 'Sign in to save more than 20 bookmarks.',
      'limit.import': 'Sign in to import bookmarks.',
      'limit.uploadWp': 'Sign in to upload your own wallpapers.',
      'limit.customWp': 'Sign in to use custom wallpapers.',
      // tour
      'tour.skip': 'Skip tour',
      'tour.next': 'Next →',
      'tour.done': 'Done',
    ...
    ru: {
      ...
      'activation.enterSub': 'После оплаты код придёт на почту.<br>Вставьте его сюда, чтобы открыть BlackCodex Bookmark Manager.',
      ...
      'st.thanks': 'Спасибо, что поддерживаете BlackCodex Bookmark Manager.',
      ...
      'st.version': 'Версия',
      'st.contact': 'Написать',
      'limit.pages': 'Войдите, чтобы создавать несколько страниц.',
      'limit.boards': 'Войдите, чтобы добавить больше 3 досок.',
      'limit.bookmarks': 'Войдите, чтобы сохранить больше 20 закладок.',
      'limit.import': 'Войдите, чтобы импортировать закладки.',
      'limit.uploadWp': 'Войдите, чтобы загружать свои обои.',
      'limit.customWp': 'Войдите, чтобы использовать свои обои.',
